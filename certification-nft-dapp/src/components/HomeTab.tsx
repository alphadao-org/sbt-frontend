...
<section className="text-center py-8 relative overflow-hidden">
  ...
  <div className="max-w-5xl mx-auto relative">
    ...
    >
      Transform your Web3 journey with <strong>ALPHA DAO</strong> — your gateway
      to blockchain mastery. Learn decentralized technologies, earn verified{" "}
      <span className="text-purple-600 font-semibold">NFT credentials</span>, and
      join the next billion shaping the future of Web3.
    </p>
...
<section className="mb-10">
  ...
  >
    <div className="text-center">
      ...
      >
        View ALPHA DAO certificates and transactions directly on the TON testnet explorer.
      </p>
      <a
...
<section className="mb-10">
  <div className="text-center mb-8">
    ...
    >
      Master Web3 fundamentals through ALPHA DAO’s curated curriculum. From blockchain basics to
      advanced DeFi strategies — earn verifiable NFT credentials recognized globally.
    </p>
  </div>
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          >
            Discover the revolutionary technology powering Bitcoin, Ethereum, and beyond. Master
            consensus mechanisms, cryptographic security, and decentralized validation that make
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          >
            Dive deep into TON's groundbreaking architecture — the fastest, most scalable blockchain
            designed for mass adoption. Learn how it achieves 100,000+ TPS while maintaining
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          >
            Unlock the power of digital ownership. Master NFT standards, smart contract
            interactions, and the technology behind billion-dollar digital economies on TON's
